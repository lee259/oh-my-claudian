...
- `supportsNativeHistory` remains false: local transcript hydration restores persisted Claudian records, but does not provide Cursor's native session list or resume UI.
