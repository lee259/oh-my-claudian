...
const localizedKeys = [
  ...
  'chat.composer.addContext',
  'chat.composer.externalFilesAndFolders',
  'chat.composer.externalContextManagerTitle',
  'chat.composer.externalContextManagerDescription',
  'chat.composer.externalContextAcrossSessions',
  'chat.composer.externalContextThisConversation',
  'chat.composer.externalContextNoFolders',
  'chat.composer.manageExternalFolders',
  'chat.composer.persistExternalFolder',
  'chat.composer.makeExternalFolderSessionOnly',
  'chat.composer.removeExternalFolder',
  'chat.composer.externalContextPickerTitle',
  'chat.composer.externalContextInvalidPathsRemoved',
  'chat.composer.externalContextCannotPersist',
  'chat.composer.externalContextNoPath',
  'chat.composer.externalContextPathMustBeAbsolute',
  'chat.composer.externalContextPathNotDirectory',
  'chat.composer.externalContextPathNotFile',
  'chat.composer.externalContextPathNotFound',
  'chat.composer.externalContextPermissionDenied',
  'chat.composer.externalContextCannotAccessPath',
  'chat.composer.externalContextSelectedPathNotFileOrFolder',
  'chat.composer.externalContextCannotAccessSelectedPath',
  'chat.composer.externalContextOpenPickerFailed',
  'chat.composer.externalContextAlreadyAdded',
  'chat.composer.externalContextNestedPath',
  'chat.composer.externalContextContainsExistingPath',
  'chat.composer.externalContextAdded',
  'chat.composer.contextPathNotInVault',
  ...
  'settings.agentSkills.sharedExpectation',
  'settings.agentSkills.noSkills',
  'settings.agentSkills.skillBadge',
  'settings.agentSkills.diagnosticsTitle',
  'settings.agentSkills.loadFailed',
